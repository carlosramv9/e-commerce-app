...
function POSCobrarSectionInner({
  ...
  return (
    <>
      ...
      <section
        className="border-b border-slate-200/60 bg-white/60 backdrop-blur-sm px-4 md:px-6 py-3 md:py-4 shrink-0"
      ...
      >
        <div className="flex gap-2 md:gap-3">
          ...
          >
            <SelectTrigger
              className="w-32 md:w-48 h-10 md:h-11 bg-white/60 border-slate-200/80"
